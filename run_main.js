...
let collection_time_before_date = "2026.07.30"   // например "2026.07.02" // Пустая дата = без ограничения по дате
...
// Используется в конце этого файла как единственная точка запуска парсера через run_main.js.
function launchMain() {
    const args = [
        mainJsPath,
        `--groupId=${groupId}`,
